	...
	extends StorageTest
{
	...
	public void testDefault()
	{
		...
		assertThat(createdValue.get(), is(100.5));
	}
	...
	public void testDefaultString()
	{
		...
		var createdValue = fetched.getField("field", SimpleValue.class).get();
		assertThat(createdValue.get(), is(100.2));
	}
	...
	public void testDefaultCanBeOverridden()
	{
		...
		var stored = collection.store(
			collection.newMutation()
				.updateField("field", ScalarValueMutation.createFloat(200d))
				.build()
		).block();
		...
		var createdValue = fetched.getField("field", SimpleValue.class).get();
		assertThat(createdValue.get(), is(200d));
	}
}
