package com.circumgraph.graphql.types.localdatetimes;
...
public class LocalDateTimeSearchTest
	extends SingleSchemaGraphQLTest
{
	...
	public void testStore()
	{
		...
		assertThat(result.pick("storeTest", "created"), is("2021-01-01T14:10:30"));
	}
	...
	public void testSearchWithEqualsMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { equals: \"2021-01-01T14:10:30\" } } }
					]) {
						totalCount,
	...
	public void testSearchWithEqualsNoMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { equals: \"2021-01-01T14:10:31\" } } }
					]) {
						totalCount,
	...
	public void testSearchWithRangeMinMaxInclusiveMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { range: { min: \"2021-01-01T14:10:30\", max: \"2021-01-01T15:10:29\" } } } }
					]) {
						totalCount,
	...
	public void testSearchWithRangeMinMaxExclusiveMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { range: { min: \"2021-01-01T14:10:30\", max: \"2021-01-01T14:10:31\", maxInclusive: false } } } }
					]) {
						totalCount,
	...
	public void testSearchWithRangeMinMaxInclusiveMatchMultiple()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { range: { min: \"2021-01-01T14:10:30\", max: \"2021-01-01T15:10:30\" } } } }
					]) {
						totalCount,
	...
	public void testSearchWithRangeMinInclusiveMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { range: { min: \"2021-01-01T15:20:30\" } } } }
					]) {
						totalCount,
	...
	public void testSearchWithRangeMinExclusiveNoMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { range: { min: \"2021-01-01T14:50:30\", minInclusive: false } } } }
					]) {
						totalCount,
	...
	public void testSearchWithRangeMaxInclusiveMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { range: { max: \"2021-01-01T14:10:30\" } } } }
					]) {
						totalCount,
	...
	public void testSearchWithRangeMaxExclusiveMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { range: { max: \"2021-01-01T14:10:31\", maxInclusive: false } } } }
					]) {
						totalCount,
