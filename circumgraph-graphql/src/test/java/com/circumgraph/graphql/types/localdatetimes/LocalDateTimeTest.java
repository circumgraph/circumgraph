	...
	extends SingleSchemaGraphQLTest
{
	...
	public void testStore()
	{
		...
		var result = execute(
			...
			Maps.immutable.of(
				"m", Maps.immutable.of(
					"created", "2021-01-01T06:07:30.999"
				)
			)
		);
		...
		assertThat(result.pick("storeTest", "created"), is("2021-01-01T06:07:30.999"));
	}
	...
	public void testStoreInvalid()
	{
		...
		assertThat(error.getMessage(), containsString("Invalid LocalDateTime format"));
	}
	...
	public void testUpdateValue()
	{
		...
		result = execute(
			...
			Maps.mutable.of(
				"id", id,
				"m", Maps.mutable.of(
					"created", "2021-01-01T06:00:30.999"
				)
			)
		);
		...
		assertThat(result.pick("storeTest", "created"), is("2021-01-01T06:00:30.999"));
	}
}
