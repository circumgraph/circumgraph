	...
	extends SingleSchemaGraphQLTest
{
	...
	public void testStore()
	{
		...
		assertThat(result.pick("storeTest", "created"), is("14:10:30-02:00"));
	}
	...
	public void testSearchWithEqualsMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { equals: \"16:10:30Z\" } } }
					]) {
						totalCount,
	...
	public void testSearchWithEqualsNoMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { equals: \"14:10:31-02:00\" } } }
					]) {
						totalCount,
	...
	public void testSearchWithEqualsMatchMultiple()
	{
		...
		var result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { equals: \"14:10:30-02:00\" } } }
					]) {
						totalCount,
	...
	public void testSearchWithRangeMinMaxInclusiveMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { range: { min: \"14:10:30-02:00\", max: \"14:10:29-03:00\" } } } }
					]) {
						totalCount,
	...
	public void testSearchWithRangeMinMaxExclusiveMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { range: { min: \"14:10:30-02:00\", max: \"14:10:31-02:00\", maxInclusive: false } } } }
					]) {
						totalCount,
	...
	public void testSearchWithRangeMinMaxInclusiveMatchMultiple()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { range: { min: \"14:10:30-02:00\", max: \"15:10:30-02:00\" } } } }
					]) {
						totalCount,
	...
	public void testSearchWithRangeMinInclusiveMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { range: { min: \"15:20:30-02:00\" } } } }
					]) {
						totalCount,
	...
	public void testSearchWithRangeMinExclusiveNoMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { range: { min: \"14:50:30-02:00\", minInclusive: false } } } }
					]) {
						totalCount,
	...
	public void testSearchWithRangeMaxInclusiveMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { range: { max: \"14:10:30-02:00\" } } } }
					]) {
						totalCount,
	...
	public void testSearchWithRangeMaxExclusiveMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { range: { max: \"14:10:31-02:00\", maxInclusive: false } } } }
					]) {
						totalCount,
