package com.circumgraph.graphql.types.localdates;
...
public class LocalDateSearchTest
	extends SingleSchemaGraphQLTest
{
	...
	public void testStore()
	{
		...
		assertThat(result.pick("storeTest", "created"), is("2021-01-01"));
	}
	...
	public void testSearchWithEqualsMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { equals: \"2021-01-01\" } } }
					]) {
						totalCount,
	...
	public void testSearchWithEqualsNoMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { equals: \"2021-02-01\" } } }
					]) {
						totalCount,
	...
	public void testSearchWithRangeMinMaxInclusiveMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { range: { min: \"2021-01-01\", max: \"2021-01-31\" } } } }
					]) {
						totalCount,
	...
	public void testSearchWithRangeMinMaxExclusiveMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { range: { min: \"2021-01-01\", max: \"2021-02-01\", maxInclusive: false } } } }
					]) {
						totalCount,
	...
	public void testSearchWithRangeMinInclusiveMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { range: { min: \"2021-02-01\" } } } }
					]) {
						totalCount,
	...
	public void testSearchWithRangeMinExclusiveNoMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { range: { min: \"2021-02-01\", minInclusive: false } } } }
					]) {
						totalCount,
	...
	public void testSearchWithRangeMaxInclusiveMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { range: { max: \"2021-01-31\" } } } }
					]) {
						totalCount,
	...
	public void testSearchWithRangeMaxExclusiveMatch()
	{
		...
		result = execute("""
			query {
				test {
					search(criteria: [
						{ field: { created: { range: { max: \"2021-02-01\", maxInclusive: false } } } }
					]) {
						totalCount,
