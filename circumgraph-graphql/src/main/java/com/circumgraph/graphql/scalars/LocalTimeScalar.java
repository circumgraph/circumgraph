	...
	implements ScalarMapper<LocalTime>
{
	...
	@Override
	public LocalTime fromInput(Object inputValue)
	{
		if(inputValue instanceof LocalTime localTime)
		{
			return localTime;
		}

		return LocalTime.parse(inputValue.toString(), DateTimeFormatter.ISO_LOCAL_TIME);
	}
}
